...
var c1 = new crawler({
    ...
    callback: function(error, res, done) {
        if (error) {
            ...
            var pron = $("#page-content .page div:first-child div:first-child .link .superentry .di-body .entry .entry-body div:first-child .pos-header .us .pron .ipa").text()
            if (pron == "") {
                pron = $("#page-content .page div:first-child div:first-child .link .superentry .di-body .entry .entry-body div:first-child .pos-header .uk .pron .ipa").text()
            }
